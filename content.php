...
<div class="row" style="text-align: center;"><h1><?php echo ucfirst($cate); ?> (<?php echo ucfirst($type); ?>)</h1></div>


<div class="row">
<?php 

$query = "SELECT * FROM item WHERE item_type='$type' AND item_category='$cate'";
$result = get($query,$conn);
...
for($i=1;$i<=$page;$i++)
{
    echo "<a href='content.php?category=$cate&type=$type&page=$i'>$i</a>";
}
 ?>
</div>
